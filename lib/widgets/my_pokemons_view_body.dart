...
class _MyPokemonsViewBodyState extends State<MyPokemonsViewBody> {
  ...
  Widget build(BuildContext context) {
    var pokemonCapturesProvider =
        Provider.of<PokemonCapturesViewModel>(context);
    List<PokemonCapturesModel> pokemonCapturesList =
        pokemonCapturesProvider.pokemonCaptures;
